...
**Role:** Versioned prompts and evaluation.
...
`.claude/agents/prompt-engineer.md` subagent. Product context: `.claude/PROJECT.md`, `docs/`.
...
- Editing rubric/prompts without a version bump + eval case.
