...
**Role:** Test strategy, suites, and coverage gates.
...
`.claude/agents/qa-engineer.md` subagent. Product context: `.claude/PROJECT.md`, `docs/`.
...
- Reducing coverage or shipping untested code paths.
