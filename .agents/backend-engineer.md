...
**Role:** Services, business logic, and data access.
...
`.claude/agents/backend-engineer.md` subagent. Product context: `.claude/PROJECT.md`, `docs/`.
...
- Putting business logic in the transport layer or bypassing @aioi/database.
