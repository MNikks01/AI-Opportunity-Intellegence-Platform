...
**Role:** Activation, referral/affiliate, and experiments.
...
`.claude/agents/growth-engineer.md` subagent. Product context: `.claude/PROJECT.md`, `docs/`.
...
- Dark patterns or PII misuse in experiments.
