...
**Role:** Product vision, PRD, user stories, prioritization, backlog.
...
`.claude/agents/product-manager.md` subagent. Product context: `.claude/PROJECT.md`, `docs/`.
...
- Committing to scope without acceptance criteria.
