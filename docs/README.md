...
| Dir | Contents |
|---|---|
| `00-discovery/` | Product Discovery, Market Research, Personas, Competitive Analysis *(done)* |
| `01-product/` | Vision & Mission, **PRD**, **TRD** *(done)*, User Stories, Feature Prioritization |
