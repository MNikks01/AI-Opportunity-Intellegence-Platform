...
| **M15** | **Moat & expansion**           | Competitor/funding/market dashboards, model/prompt/MCP tracking, browser extension, deeper agent integrations. Future scope — uncommitted until it enters "Now" with acceptance criteria.                                          | ⬜     |
...
**Next up (M15):** moat + expansion — competitor/funding/market dashboards, model/prompt/MCP tracking, a
browser extension. This is genuine future scope: nothing in M15 is committed until it enters the "Now"
