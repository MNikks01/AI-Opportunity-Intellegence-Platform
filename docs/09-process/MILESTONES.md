...
| **M15** | **Moat & expansion**           | **M15-A (supply-side tracking) SHIPPED** — [ADR-0005](../adr/ADR-0005-supply-side-tracking.md) Accepted; models/MCP/repos with momentum + `/entities` leaderboard. **M15-B (funding signal) scoped** — [ADR-0006](../adr/ADR-0006-funding-signal.md) Proposed (SEC EDGAR Form D, US-only v1), decomposed into B-033–B-037. Browser extension + global/paid funding still future scope. | 🟡     |
