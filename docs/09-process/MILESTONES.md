...
| **M15** | **Moat & expansion**           | Competitor/funding/market dashboards, model/prompt/MCP tracking, browser extension, deeper agent integrations. **M15-A (supply-side tracking) scoped — [ADR-0005](../adr/ADR-0005-supply-side-tracking.md) Proposed, decomposed into B-028–B-032.** Rest still future scope pending acceptance criteria. | 🟡     |
