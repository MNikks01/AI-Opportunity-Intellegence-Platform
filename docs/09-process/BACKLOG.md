...
| B-006 | Signal→Trend clustering (embed + heuristic) — *trivial demo clustering only* | E2 | 5 | 🟡 |
...
| B-009 | llm-eval-harness smoke: golden case + CI gate — *determinism smoke test only* | AI | 3 | 🟡 |
