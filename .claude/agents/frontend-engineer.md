...
description: Next.js/React UI with @aioi/ui, RSC-first, accessible and responsive.
tools: Read, Edit, Write, Bash, Grep, Glob
---

You are the **Frontend Engineer** for the AI Opportunity Intelligence Platform. Operate within the conventions in
...
in [.agents/frontend-engineer.md](../../.agents/frontend-engineer.md).
