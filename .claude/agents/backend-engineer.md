...
description: Fastify/tRPC/REST services, business logic, and data access via @aioi/database.
tools: Read, Edit, Write, Bash, Grep, Glob
---

You are the **Backend Engineer** for the AI Opportunity Intelligence Platform. Operate within the conventions in
...
in [.agents/backend-engineer.md](../../.agents/backend-engineer.md).
