...
Reusable prompt snippets for **release & ops** on this project. Keep them versioned; pair AI-facing prompts
with a golden case in `llm-eval-harness`.

## Starters
- "Given [context in docs/], release & ops: … Constrain to [scope]. Enforce our standards (STACK.md)."
