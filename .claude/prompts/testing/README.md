...
Reusable prompt snippets for **test generation** on this project. Keep them versioned; pair AI-facing prompts
with a golden case in `llm-eval-harness`.

## Starters
- "Given [context in docs/], test generation: … Constrain to [scope]. Enforce our standards (STACK.md)."
