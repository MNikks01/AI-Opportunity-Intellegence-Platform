...
Reusable prompt snippets for **UI generation & review** on this project. Keep them versioned; pair AI-facing prompts
with a golden case in `llm-eval-harness`.

## Starters
- "Given [context in docs/], UI generation & review: … Constrain to [scope]. Enforce our standards (STACK.md)."
