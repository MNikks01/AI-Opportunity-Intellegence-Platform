...
Reusable prompt snippets for **system design** on this project. Keep them versioned; pair AI-facing prompts
with a golden case in `llm-eval-harness`.

## Starters
- "Given [context in docs/], system design: … Constrain to [scope]. Enforce our standards (STACK.md)."
