...
Reusable prompt snippets for **planning & decomposition** on this project. Keep them versioned; pair AI-facing prompts
with a golden case in `llm-eval-harness`.

## Starters
- "Given [context in docs/], planning & decomposition: … Constrain to [scope]. Enforce our standards (STACK.md)."
